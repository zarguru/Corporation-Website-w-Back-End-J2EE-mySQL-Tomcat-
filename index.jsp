...
<table id="__01" width="1025" height="813" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		<td colspan="2" rowspan="2" width="405" height="20"><table width="100%"  border="0"  background="images/17.gif" height="20">
		  ...
		  <tr valign="top">
            <td height="19" colspan="2" background="images/014.jpg" class="zczi"><font size="0.5" color="black"><%=news.getTitle() %></font></td>
        </tr>
		  <%}%>
        </table>
	  </td>
		 ...
		 <!-- 分栏显示 -->
            <%
					...
					for (int i = 0 ;i<HRow;i++){%>		 
						...
						<img scr="images/spimg/<%=Rs.getString("img")%>" width="70" height="70"><%=Rs.getString("name")%>
						<%}%>
...
<map name="Map5">
  <area shape="rect" coords="475,35,523,49" href="#" onclick="this.style.behavior='url(#default#homepage)';this.sethomepage('http://localhost/net_test')">
  <area shape="rect" coords="628,38,676,50" href="mailto:tmoonbook@sina.com">
  <area shape="rect" coords="551,37,602,49" href="javascript:window.external.AddFavorite('http://localhost/net_test','企业门户')">
</map>
</body>
</html>